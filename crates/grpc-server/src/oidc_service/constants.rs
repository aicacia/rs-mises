...
pub const TOKEN_AUTH_SIGNING_ALG_ES256K: &str = "ES256K";
pub const TOKEN_AUTH_SIGNING_ALGS_SUPPORTED: &[&str] = &[TOKEN_AUTH_SIGNING_ALG_ES256K];
...
pub const ID_TOKEN_SIGNING_ALGS_SUPPORTED: &[&str] = &[TOKEN_AUTH_SIGNING_ALG_ES256K];
