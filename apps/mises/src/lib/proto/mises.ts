...
export const TokenRequest: MessageFns<TokenRequest> = {
	...
	fromPartial(object: DeepPartial<TokenRequest>): TokenRequest {
		...
		message.authorizationCode =
			object.authorizationCode !== undefined && object.authorizationCode !== null
		...
		message.clientCredentials =
			object.clientCredentials !== undefined && object.clientCredentials !== null
				? ClientCredentials.fromPartial(object.clientCredentials)
				: undefined;
		message.deviceCode =
			object.deviceCode !== undefined && object.deviceCode !== null
		...
		message.deviceCredentials =
			object.deviceCredentials !== undefined && object.deviceCredentials !== null
...
export const ClientRegisterRequest: MessageFns<ClientRegisterRequest> = {
	encode(message: ClientRegisterRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
		...
		if (message.clientUri !== undefined) {
			writer.uint32(106).string(message.clientUri);
		}
		if (message.logoUri !== undefined) {
			writer.uint32(114).string(message.logoUri);
		}
		if (message.policyUri !== undefined) {
			writer.uint32(122).string(message.policyUri);
		}
		if (message.tosUri !== undefined) {
			writer.uint32(130).string(message.tosUri);
		}
		if (message.jwksUri !== undefined) {
			writer.uint32(138).string(message.jwksUri);
		}
		if (message.jwks !== undefined) {
			writer.uint32(146).string(message.jwks);
		}
		if (message.sectorIdentifierUri !== undefined) {
			writer.uint32(154).string(message.sectorIdentifierUri);
		}
		if (message.subjectType !== undefined) {
			writer.uint32(162).string(message.subjectType);
		}
		if (message.idTokenSignedResponseAlg !== undefined) {
			writer.uint32(170).string(message.idTokenSignedResponseAlg);
		}
		if (message.idTokenEncryptedResponseAlg !== undefined) {
			writer.uint32(178).string(message.idTokenEncryptedResponseAlg);
		}
		if (message.idTokenEncryptedResponseEnc !== undefined) {
			writer.uint32(186).string(message.idTokenEncryptedResponseEnc);
		}
		if (message.userinfoSignedResponseAlg !== undefined) {
			writer.uint32(194).string(message.userinfoSignedResponseAlg);
		}
		if (message.userinfoEncryptedResponseAlg !== undefined) {
			writer.uint32(202).string(message.userinfoEncryptedResponseAlg);
		}
		if (message.userinfoEncryptedResponseEnc !== undefined) {
			writer.uint32(210).string(message.userinfoEncryptedResponseEnc);
		}
		if (message.requestObjectSigningAlg !== undefined) {
			writer.uint32(218).string(message.requestObjectSigningAlg);
		}
		if (message.requestObjectEncryptionAlg !== undefined) {
			writer.uint32(226).string(message.requestObjectEncryptionAlg);
		}
		if (message.requestObjectEncryptionEnc !== undefined) {
			writer.uint32(234).string(message.requestObjectEncryptionEnc);
		}
		if (message.tokenEndpointAuthSigningAlg !== undefined) {
			writer.uint32(242).string(message.tokenEndpointAuthSigningAlg);
		}
		if (message.defaultMaxAge !== undefined) {
			writer.uint32(248).uint64(message.defaultMaxAge);
		}
		if (message.requireAuthTime !== undefined) {
			writer.uint32(256).bool(message.requireAuthTime);
		}
		for (const v of message.defaultAcrValues) {
			writer.uint32(266).string(v!);
		}
		if (message.initiateLoginUri !== undefined) {
			writer.uint32(274).string(message.initiateLoginUri);
		}
		...
		if (message.frontchannelLogoutUri !== undefined) {
			writer.uint32(298).string(message.frontchannelLogoutUri);
		}
		if (message.frontchannelLogoutSessionRequired !== undefined) {
			writer.uint32(304).bool(message.frontchannelLogoutSessionRequired);
		}
		if (message.backchannelLogoutUri !== undefined) {
			writer.uint32(314).string(message.backchannelLogoutUri);
		}
		if (message.backchannelLogoutSessionRequired !== undefined) {
			writer.uint32(320).bool(message.backchannelLogoutSessionRequired);
		}
		if (message.accessTokenExpiry !== undefined) {
			writer.uint32(328).uint64(message.accessTokenExpiry);
		}
		if (message.refreshTokenExpiry !== undefined) {
			writer.uint32(336).uint64(message.refreshTokenExpiry);
		}
		return writer;
	},
	...
	fromPartial(object: DeepPartial<ClientRegisterRequest>): ClientRegisterRequest {
		...
		message.frontchannelLogoutSessionRequired =
			object.frontchannelLogoutSessionRequired ?? undefined;
...
export const OpenIdConfiguration: MessageFns<OpenIdConfiguration> = {
	...
	fromPartial(object: DeepPartial<OpenIdConfiguration>): OpenIdConfiguration {
		...
		message.tokenEndpointAuthMethodsSupported =
			object.tokenEndpointAuthMethodsSupported?.map((e) => e) || [];
		...
		message.codeChallengeMethodsSupported =
			object.codeChallengeMethodsSupported?.map((e) => e) || [];
		message.subjectTypesSupported = object.subjectTypesSupported?.map((e) => e) || [];
		message.idTokenSigningAlgValuesSupported =
			object.idTokenSigningAlgValuesSupported?.map((e) => e) || [];
		message.idTokenEncryptionAlgValuesSupported =
			object.idTokenEncryptionAlgValuesSupported?.map((e) => e) || [];
		message.idTokenEncryptionEncValuesSupported =
			object.idTokenEncryptionEncValuesSupported?.map((e) => e) || [];
		message.userinfoSigningAlgValuesSupported =
			object.userinfoSigningAlgValuesSupported?.map((e) => e) || [];
		message.userinfoEncryptionAlgValuesSupported =
			object.userinfoEncryptionAlgValuesSupported?.map((e) => e) || [];
		message.requestObjectSigningAlgValuesSupported =
			object.requestObjectSigningAlgValuesSupported?.map((e) => e) || [];
		...
		message.pushedAuthorizationRequestEndpoint =
			object.pushedAuthorizationRequestEndpoint ?? undefined;
		return message;
	}
};
...
export const IsAllowedForUserRequest: MessageFns<IsAllowedForUserRequest> = {
	encode(
		message: IsAllowedForUserRequest,
		writer: BinaryWriter = new BinaryWriter()
	): BinaryWriter {
		if (message.clientId !== '') {
			writer.uint32(10).string(message.clientId);
...
export interface OidcServiceImplementation<CallContextExt = {}> {
	...
	): Promise<DeepPartial<AuthorizeResponse>>;
	/** Token endpoint supporting multiple grant types */
	token(
		request: TokenRequest,
		context: CallContext & CallContextExt
	): Promise<DeepPartial<TokenResponse>>;
	/** Device Authorization endpoint */
	deviceAuthorize(
...
export interface OidcServiceClient<CallOptionsExt = {}> {
	...
	/** Revocation (returns empty on success) */
	revoke(
		request: DeepPartial<RevokeRequest>,
		options?: CallOptions & CallOptionsExt
	): Promise<Empty>;
	/** Pushed Authorization Request */
	pushedAuthorize(
	...
	/** Dynamic client registration */
	clientRegister(
		request: DeepPartial<ClientRegisterRequest>,
		options?: CallOptions & CallOptionsExt
	): Promise<Client>;
	/** RP-initiated logout */
	endSession(
...
export interface ClientServiceClient<CallOptionsExt = {}> {
	get(
		request: DeepPartial<GetClientRequest>,
		options?: CallOptions & CallOptionsExt
	): Promise<Client>;
	isAllowedForUser(
	...
	approveForUser(
		request: DeepPartial<ApproveForUserRequest>,
		options?: CallOptions & CallOptionsExt
	): Promise<Empty>;
}
